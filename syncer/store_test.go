...
func TestStoreInsert(t *testing.T) {
	...
	err = store.GetAll("SyncerTest", retrievedModel, func(rec *Record) error {
		b = append(b, rec.New)
		return nil
	})
	if err != nil {
	...
	b = nil
	err = store.GetAll("StoreTest", retrievedModel2, func(rec *Record) error {
		b = append(b, rec.New)
		return nil
	})
	if err != nil {
...
func TestStoreDelete(t *testing.T) {
	...
	var count uint8
	err = store.GetAll("StoreTest", retrievedModel, func(rec *Record) error {
